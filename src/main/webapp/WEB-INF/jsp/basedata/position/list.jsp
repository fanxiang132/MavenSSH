...
<html>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> ip列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li>
          <input type="text" placeholder="请输入IP" name="keywords" class="input" style="width:250px; line-height:17px;display:inline-block" />
    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
        <s:iterator value="#ips" status="num">
        <tr>
